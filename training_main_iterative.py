...
test_datafile=datadir+'/test_dataset.list_fold'
...
import time
data_all_dict_padding_interval15 = load_train_test_data_padding_with_interval(datadir, 500, 'kmax30',ktop_node,1150,train=True)
testdata_all_dict_padding_interval15 = load_train_test_data_padding_with_interval(datadir,500, 'kmax30',ktop_node,1150,train=False)

start_time = time.time()

DLS2F_train_complex_win_filter_layer_opt(data_all_dict_padding_interval15,testdata_all_dict_padding_interval15,train_datafile,val_datafile,test_datafile,CV_dir,"DLS2F",10,in_epoch,1150,filetsize_array,True,'sigmoid',nb_filters,nb_layers,opt,hidden_num,ktop_node)


data_all_dict_padding_interval15 = load_train_test_data_padding_with_interval(datadir, 200, 'kmax30',ktop_node,1150,train=True)
testdata_all_dict_padding_interval15 = load_train_test_data_padding_with_interval(datadir,200, 'kmax30',ktop_node,1150,train=False)
...
data_all_dict_padding_interval15 = load_train_test_data_padding_with_interval(datadir, 100, 'kmax30',ktop_node,1150,train=True)
testdata_all_dict_padding_interval15 = load_train_test_data_padding_with_interval(datadir,100, 'kmax30',ktop_node,1150,train=False)
...
data_all_dict_padding_interval15 = load_train_test_data_padding_with_interval(datadir, 50, 'kmax30',ktop_node,1150,train=True)
testdata_all_dict_padding_interval15 = load_train_test_data_padding_with_interval(datadir,50, 'kmax30',ktop_node,1150,train=False) 
