...
system("$prosys_dir/parse_hhsearch.pl $prefix.hhr $prefix.hhs");

system("$prosys_dir/hhsearch_align_comb.pl $prosys_dir/ $query_file  $prefix.hhs 1 1 1 1 1 1 $out_file");
